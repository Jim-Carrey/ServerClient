...
public class Server {
	...
	// 构造方法
	public Server() {
		frame = new JFrame("DJTU局域网通信服务器_by_CSD");
		// 更改JFrame的图标：
		...
		leftPanel.setBorder(new TitledBorder("大厅"));
		...
		btn_start.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					contentArea.append("服务器大厅成功启动!人数上限：" + max + ",端口：" + port
							+ "\r\n");
